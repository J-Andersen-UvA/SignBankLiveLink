...
class MOCAPPROLIVELINK_API FMocapProLiveLinkSource : public ILiveLinkSource, public FRunnable
{
public:

	FMocapProLiveLinkSource(FIPv4Endpoint Endpoint);

	virtual ~FMocapProLiveLinkSource();
