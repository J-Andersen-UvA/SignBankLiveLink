...
#include "MocapProLiveLinkSourceFactory.generated.h"

class SMocapProLiveLinkSourceEditor;

UCLASS()
class UMocapProLiveLinkSourceFactory : public ULiveLinkSourceFactory
{
public:
